...
<head>
    ...
    <style>
        ...
        td, th {
            /* border: 1px solid #dddddd; */ /* Remove border */
            text-align: left;
            padding: 8px;
            text-align: center;
            border: none; /* Remove border */
        ...
        th {
            /* background-color: #f2f2f2; */ /* Remove background color */
        }
...
<body>
    <div class="d-flex">
        ...
        <div class="header">
            <h1>EVALUATION: Small Province</h1>
        </div>
        <div class="content">
            <div class="box-content">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>CAR</td>
                            <td><input type="text" class="rounded-input-box" placeholder="SCORE"></td>
                            <td class="view-button">View File</td>
