                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><b>C.2. Implementation of Agency Action Plan and Status of Implementation (AAPSI) on the Prior Years Audit Recommendation = </b><i>125</i><br>
                                <ul><i>80% acted upon (either partially or fully implemented)</i></ul>
                        ...
                        <tr>
                            <td>
                                <b>C.3.3. Percentage of Personnel Attendance to Finance related training programs</b><br>
                        ...
                        <tr>
                            <td>
                                <b>C.4. Model Employee Awards</b><br>
                        ...
                        <tr>
                            <td>
                                <b>C.4.2. Model Employee for Category II Position</b>
                        ...
                        <tr>
                            <td>
                            <b>C.5. Application for PRIME-HR Level</b>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="textbox" id="textbox" class="textbox" placeholder="Score"></td>
                            <td><input type="file" name="fileUpload" id="fileUpload">
                                <br><i><ul>*Letter to CSC and other communications with regard to the requirements submitted by the region to CSC (with CSC feedback/reply letter)</ul></i>
                            </td>
                            <td><button class="btn btn-primary btn-sm">Evaluate</button></td>
                            <td><textarea name="comments" id="comments" class="comments"></textarea></td>
                        </tr>                        
