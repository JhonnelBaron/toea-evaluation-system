    ...
    <div>
        ...
        <div class="ml-72 p-3">
            ...
            <p class="text-3xl"><b  style="font-family: 'Poppins', sans-serif">{{$region->region_name}}</b></p>
                ...
                <div class="d-flex">
                    <button onclick="window.location.href='/region-folders'" class="flex items-center px-4 py-2 text-black text-sm font-medium rounded-md  focus:outline-none focus:ring-2  focus:ring-opacity-50">
