...
<body>
    <div>
        ...
        <div class="ml-72 p-4">
            ...
            <div class="d-flex">
                <button onclick="window.location.href='/executive-office-dashboard'" class="flex items-center px-4 py-2 text-black text-sm font-medium rounded-md  focus:outline-none focus:ring-2  focus:ring-opacity-50">
