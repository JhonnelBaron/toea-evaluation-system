                        ...
                        <tbody class="">
                            ...
                            <tr class="region-row small" data-category="small">
                                ...
                                <td class="px-5 py-1">                                    
                                    ...
                                    <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                        <div class="p-2">
                                            <p>Criteria A: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][13]['rst_a_externals'] ?? 0 }}</span></p>
                                            <p>Criteria B: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][13]['rst_b_externals'] ?? 0 }}</span></p>
                                            <p>Criteria C: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][13]['rst_c_externals'] ?? 0 }}</span></p>
                                            <p>Criteria D: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][13]['rst_d_externals'] ?? 0 }}</span></p>
                                            <p>Criteria E: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][13]['rst_e_externals'] ?? 0 }}</span></p>
                                        </div>
                            ...
                            <td class="px-5 py-1">
                                <div class="hoverable relative flex items-center justify-center max-w-xs">
                                    ...
                                    <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                        <div class="p-2">
                                            <p>Criteria A: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][16]['rst_a_externals'] ?? 0 }}</span></p>
                                            <p>Criteria B: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][16]['rst_b_externals'] ?? 0 }}</span></p>
                                            <p>Criteria C: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][16]['rst_c_externals'] ?? 0 }}</span></p>
                                            <p>Criteria D: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][16]['rst_d_externals'] ?? 0 }}</span></p>
                                            <p>Criteria E: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][16]['rst_e_externals'] ?? 0 }}</span></p>
                                        </div>
                                        <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                    </div>
                                </div>
                            ...
                            <td class="px-5 py-1">
                                ...
                                {{ $smallScores[$user->user_id]['scores'][17] ?? 0 }}                                        <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                    <div class="p-2">
                                        <p>Criteria A: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][17]['rst_a_externals'] ?? 0 }}</span></p>
                                        <p>Criteria B: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][17]['rst_b_externals'] ?? 0 }}</span></p>
                                        <p>Criteria C: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][17]['rst_c_externals'] ?? 0 }}</span></p>
                                        <p>Criteria D: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][17]['rst_d_externals'] ?? 0 }}</span></p>
                                        <p>Criteria E: <span class="float-right">{{ $smallScores[$user->user_id]['breakdowns'][17]['rst_e_externals'] ?? 0 }}</span></p>
                                    </div>
                                    <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                </div>
                            </div>
                            ...
                            <tr class="region-row medium" data-category="medium">
                                ...
                                <td class="px-5 py-1">
                                    <div class="hoverable relative flex items-center justify-center max-w-xs">
                                        ...
                                        <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                            <div class="p-2">
                                                <p>Criteria A: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][13]['rst_a_externals'] ?? 0 }}</span></p>
                                                <p>Criteria B: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][13]['rst_b_externals'] ?? 0 }}</span></p>
                                                <p>Criteria C: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][13]['rst_c_externals'] ?? 0 }}</span></p>
                                                <p>Criteria D: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][13]['rst_d_externals'] ?? 0 }}</span></p>
                                                <p>Criteria E: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][13]['rst_e_externals'] ?? 0 }}</span></p>
                                            </div>
                                            <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                        </div>
                                    </div>
                                ...
                                <td class="px-5 py-1">
                                    <div class="hoverable relative flex items-center justify-center max-w-xs">
                                        ...
                                        <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                            <div class="p-2">
                                                <p>Criteria A: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][16]['rst_a_externals'] ?? 0 }}</span></p>
                                                <p>Criteria B: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][16]['rst_b_externals'] ?? 0 }}</span></p>
                                                <p>Criteria C: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][16]['rst_c_externals'] ?? 0 }}</span></p>
                                                <p>Criteria D: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][16]['rst_d_externals'] ?? 0 }}</span></p>
                                                <p>Criteria E: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][16]['rst_e_externals'] ?? 0 }}</span></p>
                                            </div>
                                            <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                        </div>
                                    </div>
                                ...
                                <td class="px-5 py-1">
                                    ...
                                    {{ $mediumScores[$user->user_id]['scores'][17] ?? 0 }}                                        <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                        <div class="p-2">
                                            <p>Criteria A: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][17]['rst_a_externals'] ?? 0 }}</span></p>
                                            <p>Criteria B: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][17]['rst_b_externals'] ?? 0 }}</span></p>
                                            <p>Criteria C: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][17]['rst_c_externals'] ?? 0 }}</span></p>
                                            <p>Criteria D: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][17]['rst_d_externals'] ?? 0 }}</span></p>
                                            <p>Criteria E: <span class="float-right">{{ $mediumScores[$user->user_id]['breakdowns'][17]['rst_e_externals'] ?? 0 }}</span></p>
                                        </div>
                                        <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                    </div>
                                </div>
                            ...
                            <tr class="region-row large" data-category="large">
                                ...
                                <td class="px-5 py-1">
                                    <div class="hoverable relative flex items-center justify-center max-w-xs">
                                        ...
                                        <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                            <div class="p-2">
                                                <p>Criteria A: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][13]['ptc_a_externals'] ?? 0 }}</span></p>
                                                <p>Criteria B: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][13]['ptc_b_externals'] ?? 0 }}</span></p>
                                                <p>Criteria C: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][13]['ptc_c_externals'] ?? 0 }}</span></p>
                                                <p>Criteria D: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][13]['ptc_d_externals'] ?? 0 }}</span></p>
                                                <p>Criteria E: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][13]['ptc_e_externals'] ?? 0 }}</span></p>
                                            </div>
                                            <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                        </div>
                                    </div>
                                ...
                                <td class="px-5 py-1">
                                    <div class="hoverable relative flex items-center justify-center max-w-xs">
                                        ...
                                        <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                            <div class="p-2">
                                                <p>Criteria A: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][16]['ptc_a_externals'] ?? 0 }}</span></p>
                                                <p>Criteria B: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][16]['ptc_b_externals'] ?? 0 }}</span></p>
                                                <p>Criteria C: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][16]['ptc_c_externals'] ?? 0 }}</span></p>
                                                <p>Criteria D: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][16]['ptc_d_externals'] ?? 0 }}</span></p>
                                                <p>Criteria E: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][16]['ptc_e_externals'] ?? 0 }}</span></p>
                                            </div>
                                            <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                        </div>
                                    </div>
                                ...
                                <td class="px-5 py-1">
                                    ...
                                    {{ $largeScores[$user->user_id]['scores'][17] ?? 0 }}                                        <div class="popover absolute left-24 ml-2 top-1/2 transform -translate-y-1/2 z-10 invisible inline-block px-4 py-2 text-sm font-small text-gray-600 transition-opacity duration-300 bg-white rounded-lg shadow-sm opacity-0 bg-white-700" style="width: 200px;">
                                        <div class="p-2">
                                            <p>Criteria A: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][17]['ptc_a_externals'] ?? 0 }}</span></p>
                                            <p>Criteria B: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][17]['ptc_b_externals'] ?? 0 }}</span></p>
                                            <p>Criteria C: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][17]['ptc_c_externals'] ?? 0 }}</span></p>
                                            <p>Criteria D: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][17]['ptc_d_externals'] ?? 0 }}</span></p>
                                            <p>Criteria E: <span class="float-right">{{ $largeScores[$user->user_id]['breakdowns'][17]['ptc_e_externals'] ?? 0 }}</span></p>
                                        </div>
                                        <div class="tooltip-arrow absolute -left-2 top-1/2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-white dark:border-r-white"></div>
                                    </div>
                                </div>
