                                ...
                                <th>Remarks</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><p class="small mb-1" style="font-size: 10px;">Means of Verification: Monitoring logbook/ registry</p></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc1_final_score" type="text" placeholder="Input your initial score" required>
                                                ...
                                                <tr>
                                                    <td>C.2. Implementation of Agency Action Plan and Status of Implementation (AAPSI) on the Prior Years Audit Recommendation</td>
                                                    <td></td>
                                                    <td><p class="small mb-1" style="font-size: 10px;">Means of Verification: Agency Action Plan and Status of Implementation (AAPSI)</p></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc2_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                                    ...
                                                                    <option value="5">15 - 80% - 89% acted upon (either partially or fully implemented)</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><p class="small mb-1" style="font-size: 10px;">Means of Verification: Provincial Work Force Development Plan (WFDP)<br>
                                                            List of PO personnel in 2023<br>
                                                            Certificates of trainings attended<br>
                                                            Copies of REAPs</p></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc31_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><p class="small mb-1" style="font-size: 10px;">Means of Verification: List of PO personnel in 2023<br>
                                                            Certificates of training programs attended<br></p></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc32_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><p class="small mb-1" style="font-size: 10px;">Means of Verification: List of nominees and awardees from HRMD/AS</p></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc411_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc412_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc421_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                                    <option value="5">5 - he Province submitted nominees for Category II</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc422_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc431_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc432_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                                    <option value="6">6 - The Province has received recognition/award at national level</option>
                                                                    <option value="0">0 - The Province did not receive award/recognition at national level</option>
                                                                </select></td>
                                                ...
                                                <tr>
                                                    <td>C.5. Application for PRIME-HR Level</td>
                                                    <td></td>
                                                    <td><p class="small mb-1" style="font-size: 10px;">Means of Verification: Confernment/Certificate Awarded (if The PO has applied and has been certified in higher PRIME HR Level)<br>
                                                            Letter to CSC and other communications with regard to the requirements submitted by the region to CSC (with CSC feedback/reply letter)</p></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><select class="form-control mb-1 score-dropdown" name="rc5_final_score" type="text" placeholder="Input your initial score" required>
                                                                    <option value="">Select score</option>
                                                    ...
                                                    <td><input class="form-control mb-1" name="rc5_remarks" type="text" placeholder="Remarks"></td>
                                                </tr>
                                                <tr>
