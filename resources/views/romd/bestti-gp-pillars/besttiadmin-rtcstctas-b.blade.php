                    ...
                    <table id="regionTable" class="mx-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b1c3" data-field="b1c3" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b1d1" data-field="b1d1" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2a" data-field="b2a" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2b" data-field="b2b" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2c" data-field="b2c" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2d" data-field="b2d" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2e" data-field="b2e" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2f" data-field="b2f" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2g" data-field="b2g" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="30" {{ (isset($previousData->b2g) && $previousData->b2g == 30) ? 'selected' : '' }}>30 - The accomplishment rate based on set target is at 100% and above</option>
                                    <option value="20" {{ (isset($previousData->b2g) && $previousData->b2g == 20) ? 'selected' : '' }}>20 - The accomplishment rate based on set target is 75% - 99.99%</option>
                                    <option value="0" {{ (isset($previousData->b2g) && $previousData->b2g == 0) ? 'selected' : '' }}>0 - The accomplishment rate based on set target is 50% - 74.99%</option>
                                </select></td>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2h" data-field="b2h" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="30" {{ (isset($previousData->b2h) && $previousData->b2h == 30) ? 'selected' : '' }}>30 - The accomplishment rate based on set target is at 100% and above</option>
                                    <option value="20" {{ (isset($previousData->b2h) && $previousData->b2h == 20) ? 'selected' : '' }}>20 - The accomplishment rate based on set target is 75% - 99.99%</option>
                                    <option value="0" {{ (isset($previousData->b2h) && $previousData->b2h == 0) ? 'selected' : '' }}>0 - The accomplishment rate based on set target is 50% - 74.99%</option>
                                </select></td>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2i" data-field="b2i" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    ...
                                    <option value="0" {{ (isset($previousData->b2i) && $previousData->b2i == 0) ? 'selected' : '' }}>0 - The accomplishment rate based on set target is 50% - 74.99%</option>
                                </select></td>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b2j" data-field="b2j" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b3a" data-field="b3a" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="10" {{ (isset($previousData->b3a) && $previousData->b3a == 10) ? 'selected' : '' }}>10 - The TTI had at least one (1) certified trainer in TM Level II (any CoCs)</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b3b" data-field="b3b" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="10" {{ (isset($previousData->b3b) && $previousData->b3b == 10) ? 'selected' : '' }}>10 - The TTI had sent at least 2 trainers for industry immersion</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b3c" data-field="b3c" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="15" {{ (isset($previousData->b3c) && $previousData->b3c == 15) ? 'selected' : '' }}>15 - 70% of the TTI trainers are accredited National Competency Assessors</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b3d" data-field="b3d" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="15" {{ (isset($previousData->b3d) && $previousData->b3d == 15) ? 'selected' : '' }}>15 - 50% of the TTI's registered programs with Accredited Assessment Center</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b3e" data-field="b3e" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="25" {{ (isset($previousData->b3e) && $previousData->b3e == 25) ? 'selected' : '' }}>25 - 100% of the TTI graduates assessed</option>
                                    <option value="15" {{ (isset($previousData->b3e) && $previousData->b3e == 15) ? 'selected' : '' }}>15 - 75% - 99.99% of the TTI graduates assessed</option>
                                    <option value="10" {{ (isset($previousData->b3e) && $previousData->b3e == 10) ? 'selected' : '' }}>10 - 50% - 74.99% of the TTI graduates assessed</option>
                                    <option value="5" {{ (isset($previousData->b3e) && $previousData->b3e == 5) ? 'selected' : '' }}>5 - 25% - 49.99% of the TTI graduates assessed</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b3f" data-field="b3f" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4a1" data-field="b4a1" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4a2" data-field="b4a2" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4b" data-field="b4b" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4c" data-field="b4c" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4d" data-field="b4d" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8 text-center">
                                    @if($data->b4e1_file_verification)
                                    <button class="btn btn-sm btn-primary" onclick="openPdf('https://tesda-toea.com/{{ $data->b4e1_file_verification }}', event)">Preview</button>
                                @else
                                    No file submitted
                                @endif
                                </td>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4e1" data-field="b4e1" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="10" {{ (isset($previousData->b4e1) && $previousData->b4e1 == 0) ? 'selected' : '' }}>10 - The TTI has submitted their TAC Annual accomplishment report</option>
                                    <option value="0" {{ (isset($previousData->b4e1) && $previousData->b4e1 == 0) ? 'selected' : '' }}>0 - The TTI has not submitted their TAC Annual accomplishment report</option>
                                </select></td>
                                <td class="pb-8"><input class="form-control mb-1" name="b4e1_remarks" type="text" placeholder="Remarks" value="{{ isset($previousData->b4e1_remarks) ? $previousData->b4e1_remarks : '' }}"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-8 text-center">
                                    @if($data->b4e2_file_verification)
                                    <button class="btn btn-sm btn-primary" onclick="openPdf('https://tesda-toea.com/{{ $data->b4e2_file_verification }}', event)">Preview</button>
                                @else
                                    No file submitted
                                @endif
                                </td>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4e2" data-field="b4e2" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="5" {{ (isset($previousData->b4e2) && $previousData->b4e2 == 5) ? 'selected' : '' }}>5 - The TTI Advisory Council conducted quarterly meetings</option>
                                    <option value="0" {{ (isset($previousData->b4e2) && $previousData->b4e2 == 0) ? 'selected' : '' }}>0 - The TTI Advisory Council has not completed the quarterly meetings for the year 2023</option>
                                </select></td>
                                <td class="pb-8"><input class="form-control mb-1" name="b4e2_remarks" type="text" placeholder="Remarks" value="{{ isset($previousData->b4e2_remarks) ? $previousData->b4e2_remarks : '' }}"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-8 text-center">
                                    @if($data->b4e3_file_verification)
                                    <button class="btn btn-sm btn-primary" onclick="openPdf('https://tesda-toea.com/{{ $data->b4e3_file_verification }}', event)">Preview</button>
                                @else
                                    No file submitted
                                @endif
                                </td>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4e3" data-field="b4e3" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="5" {{ (isset($previousData->b4e3) && $previousData->b4e3 == 5) ? 'selected' : '' }}>5 - The TTI Advisory Council has submitted at least four approved resolutions</option>
                                    <option value="0" {{ (isset($previousData->b4e3) && $previousData->b4e3 == 0) ? 'selected' : '' }}>0 - The TTI Advisory Council has submitted less than four approved resolutions</option>
                                </select></td>
                                <td class="pb-8"><input class="form-control mb-1" name="b4e3_remarks" type="text" placeholder="Remarks" value="{{ isset($previousData->b4e3_remarks) ? $previousData->b4e3_remarks : '' }}"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-8 text-center">
                                    @if($data->b4f_file_verification)
                                    <button class="btn btn-sm btn-primary" onclick="openPdf('https://tesda-toea.com/{{ $data->b4f_file_verification }}', event)">Preview</button>
                                @else
                                    No file submitted
                                @endif
                                </td>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b4f" data-field="b4f" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="25" {{ (isset($previousData->b4f) && $previousData->b4f == 25) ? 'selected' : '' }}>25 - The Dual Training System (DTS) or Dual Training Program (DTP) is implemented</option>
                                    <option value="18" {{ (isset($previousData->b4f) && $previousData->b4f == 18) ? 'selected' : '' }}>18 - Curriculum of TTI program offering reviewed and updated to current technology and industry practices standards</option>
                                    <option value="10" {{ (isset($previousData->b4f) && $previousData->b4f == 10) ? 'selected' : '' }}>10 - TTI trainers undergone industry immersion with partner companies/enterprises</option>
                                    <option value="0" {{ (isset($previousData->b4f) && $previousData->b4f == 0) ? 'selected' : '' }}>0 - The Dual Training System (DTS) or Dual Training Program (DTP) is not implemented</option>
                                </select></td>
                                <td class="pb-8"><input class="form-control mb-1" name="b4f_remarks" type="text" placeholder="Remarks" value="{{ isset($previousData->b4f_remarks) ? $previousData->b4f_remarks : '' }}"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5a1" data-field="b5a1" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5a2" data-field="b5a2" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5b11" data-field="b5b11" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="10" {{ (isset($previousData->b5b11) && $previousData->b5b11 == 10) ? 'selected' : '' }}>10 - The TTI applied for APACC accreditation</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5b12" data-field="b5b12" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    ...
                                    <option value="5" {{ (isset($previousData->b5b12) && $previousData->b5b12 == 5) ? 'selected' : '' }}>5 - The TTI received APACC-Bronze accreditation</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5b21" data-field="b5b21" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                                    <option value="10" {{ (isset($previousData->b5b21) && $previousData->b5b21 == 10) ? 'selected' : '' }}>10 - The TTI participated in STAR Program</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5b22" data-field="b5b22" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5c1" data-field="b5c1" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5c2" data-field="b5c2" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5d" data-field="b5d" placeholder="Input your initial score">
                                    <option value="">Select score</option>
                            ...
                            <tr>
                                ...
                                <td class="pb-8"><select class="form-control mb-1 score-dropdown" name="b5e" data-field="b5e" placeholder="Input your initial score">
                                    <option value="">Select score</option>
