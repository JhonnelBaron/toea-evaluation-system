                             ...
                             <tr>
                                ...
                                <td class="pb-4 text-center">{{$data->re1_remarks}}</td>
                                 ...
                                 <td><select class="form-control mb-1 score-dropdown" name="e1" data-field="e1">
                                                 ...
                                                 <option value="50" {{ (isset($previousData->e1) && $previousData->e1 == 0) ? 'selected' : '' }}>50 - A Communication Plan was prepared and fully implemented</option>
                                                 <option value="30" {{ (isset($previousData->e1) && $previousData->e1 == 0) ? 'selected' : '' }}>30 - No Communication Plan was prepared but activities were fully implemented</option>
