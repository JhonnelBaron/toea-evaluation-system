                  ...
                  <table id="regionTable" class="mx-auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c1" data-field="c1">
                                <option value="">Select score</option>
                                <option value="25" {{ (isset($previousData->c1) && $previousData->c1 == 0) ? 'selected' : '' }}>25 - 100% of budget utilized</option>
                                <option value="10" {{ (isset($previousData->c1) && $previousData->c1 == 0) ? 'selected' : '' }}>10 - 90% - 99% of budget utilized</option>
                                <option value="5" {{ (isset($previousData->c1) && $previousData->c1 == 0) ? 'selected' : '' }}>5 - 89% and below of budget utilized</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c2" data-field="c2">
                                <option value="">Select score</option>
                                <option value="25" {{ (isset($previousData->c2) && $previousData->c2 == 0) ? 'selected' : '' }}>25 - 100% acted upon (either partially or fully implemented)</option>
                                <option value="15" {{ (isset($previousData->c2) && $previousData->c2 == 0) ? 'selected' : '' }}>15 - 90% - 99% acted upon (either partially or fully implemented)</option>
                                <option value="5" {{ (isset($previousData->c2) && $previousData->c2 == 0) ? 'selected' : '' }}>5 - 80% - 89% acted upon (either partially or fully implemented)</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c31" data-field="c31">
                                <option value="">Select score</option>
                                <option value="20" {{ (isset($previousData->c31) && $previousData->c31 == 0) ? 'selected' : '' }}>20 - 100% of Employees who attended SDP have implemented their Re-Entry Plans as scheduled</option>
                                <option value="10" {{ (isset($previousData->c31) && $previousData->c31 == 0) ? 'selected' : '' }}>10 - 75%- 99% of Employees who attended SDP have implemented their Re-Entry Plans as scheduled</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c32" data-field="c32">
                                <option value="">Select score</option>
                                <option value="15" {{ (isset($previousData->c32) && $previousData->c32 == 0) ? 'selected' : '' }}>15 - 100% of Employees were provided with training opportunities</option>
                                <option value="8" {{ (isset($previousData->c32) && $previousData->c32 == 0) ? 'selected' : '' }}>8 - 75%-99% of Employees were provided with training opportunities</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c411" data-field="c411">
                                <option value="">Select score</option>
                                <option value="4" {{ (isset($previousData->c411) && $previousData->c411 == 0) ? 'selected' : '' }}>4 - The TTI submitted nominees for Category I</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c412" data-field="c412">
                                <option value="">Select score</option>
                                <option value="4" {{ (isset($previousData->c412) && $previousData->c412 == 0) ? 'selected' : '' }}>4 - The TTI has received recognition/award at national level</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c421" data-field="c421">
                                <option value="">Select score</option>
                                <option value="4" {{ (isset($previousData->c421) && $previousData->c421 == 0) ? 'selected' : '' }}>4 - The TTI submitted nominees for Category II</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c422" data-field="c422">
                                <option value="">Select score</option>
                                <option value="4" {{ (isset($previousData->c422) && $previousData->c422 == 0) ? 'selected' : '' }}>4 - The TTI has received recognition/award at national level</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c431" data-field="c431">
                                <option value="">Select score</option>
                                <option value="4" {{ (isset($previousData->c431) && $previousData->c431 == 0) ? 'selected' : '' }}>4 - The TTI submitted nominees for Category III</option>
                        ...
                        <tr>
                            ...
                            <td class="pb-4"><select class="form-control mb-1 score-dropdown" name="c432" data-field="c432">
                                <option value="">Select score</option>
                                <option value="5" {{ (isset($previousData->c432) && $previousData->c432 == 0) ? 'selected' : '' }}>5 - The TTI has received recognition/award at national level</option>
