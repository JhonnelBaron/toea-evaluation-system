                ...
                <div id="evaluated" class="tab-content">
                    <table id="regionTable" class="mx-auto">
                        ...
                        <tbody>
                                                    ...
                                                    <tr>
                                                        <td><b>B.1. Provide Quality Technical Education and Skills Development and Certification for Global Competitiveness</b></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td><b>B.1.C. Participation and Awards from Skills Competition</b></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb2g_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="40">40 - The accomplishment rate based on set target is at 100% and above</option>
                                                                        <option value="25">25 - The accomplishment rate based on set target is 75% - 99.99%</option>
                                                                        <option value="10">10 - The accomplishment rate based on set target is 50% - 74.99%</option>
                                                                        <option value="0">0 - The accomplishment rate based on set target is below 50%</option>
                                                                    </select></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb2h_final_score" required>
                                                                        ...
                                                                        <option value="10">10 - The accomplishment rate based on set target is 75% - 99.99%</option>
                                                                        <option value="5">5 - The accomplishment rate based on set target is 50% - 74.99%</option>
                                                                        <option value="0"> - The accomplishment rate based on set target is below 50%</option>
                                                                    </select></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb3a_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="15">15 - The TTI had at least one (1) certified trainer in TM Level II (any CoCs)</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <select class="form-control mb-1 score-dropdown" name="rb3b_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="20">20 - The TTI had sent at least 2 trainers for industry immersion</option>
                                                                        <option value="10">10 - The TTI had sent at least 1 trainer for industry immersion</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb3c_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="20">20 - 70% of the TTI trainers are accredited National Competency Assessors</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb3d_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="20">20 - 50% of the TTI's registered programs with Accredited Assessment Center</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb3e_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="30">30 - 100% of the TTI graduates assessed</option>
                                                                        <option value="25">25 - 75% - 99.99% of the TTI graduates assessed</option>
                                                                        <option value="20">20 - 50% - 74.99% of the TTI graduates assessed</option>
                                                                        <option value="15">15 - 25% - 49.99% of the TTI graduates assessed</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td><td><p class="small mb-1" style="font-size: 10px;">Means of Verification: Letter of recommendation for all TTI graduates</p></td>
														<td></td>
                                                        <td></td>
                                                    ...
                                                    <tr>
														...
														<td></td>
                                                        <td></td>
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb4e_final_score" required>
                                                                        <option value="">Select score</option>
                                                        ...
                                                        <td><input class="form-control mb-1" name="rb4e_remarks" type="text" placeholder="Remarks"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select class="form-control mb-1 score-dropdown" name="rb5b1_1_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="5">5 - The TTI applied for APACC accreditation</option>
                                                    ...
                                                    <tr>
														...
														<td><select class="form-control mb-1 score-dropdown" name="rb5b2_1_final_score" required>
                                                                        <option value="">Select score</option>
                                                                        <option value="10">10 - TThe TTI participated in STAR Program</option>
