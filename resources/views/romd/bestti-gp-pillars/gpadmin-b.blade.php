                    ...
                    <table id="regionTable" class="mx-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1a_final_score" type="text" placeholder="Input your initial score" required>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb1a_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1b_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb1b_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1c_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb1c_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1d_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb1d_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1e_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb1e_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1f_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb1f_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1g_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb1g_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb1h_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb1i_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb1i_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2a1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2a1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2a2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2a2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2a3_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2a3_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2a4_1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2a4_1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2a4_2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2a4_2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2a4_3_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The Province received award/recognition at the international level</option>
                                        <option value="0">0 - The Province did not receive award/recognition</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2a4_3_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2b1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2b1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2b2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2b2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2b3_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="35">35 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2b3_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2b4_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2b4_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2b5_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2b5_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2c1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2c1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2c2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2c2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2c3_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2c3_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2c4_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2c4_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2c5_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="15">15 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2c5_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2c7_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2c7_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d3_1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="5">5 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d3_1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d3_2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="5">5 - The accomplishment rate based on set target is at 100% and above</option>
                                        <option value="0">0 - The accomplishment rate based on set target is below 100%</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d3_2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_1_1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_1_1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_1_2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_1_2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_2_1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_2_1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_2_2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The Province received award/recognition at the national level</option>
                                        <option value="0">0 - The Province did not receive award/recognition at the national level</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_2_2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_3_1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_3_1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_3_2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The Province received award/recognition at the national level</option>
                                        <option value="0">0 - The Province did not receive award/recognition at the national level</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_3_2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_4_1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_4_1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d4_4_2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                        <option value="10">10 - The Province received award/recognition at the national level</option>
                                        <option value="0">0 - The Province did not receive award/recognition at the national level</option>
                                    </select>
                                </td>
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d4_4_2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d5_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2d6_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score for Large Province</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2d6_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e1_1a_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e1_1a_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e1_1b_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e1_1b_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e1_2a_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e1_2a_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e1_2b_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e1_2b_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e1_3a_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e1_3a_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e1_3b_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e1_3b_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e2_1_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e2_1_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e2_2_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e2_2_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e2_3_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e2_3_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="pb-4"></td>
                                <td class="pb-4">
                                    <select class="form-control mb-1 score-dropdown" name="rb2e3_final_score" type="text" placeholder="Input your initial score" required>
                                        <option value="">Select score</option>
                                ...
                                <td class="pb-4"><input class="form-control mb-1" name="rb2e3_remarks" type="text" placeholder="Remarks"></td>
                            </tr>
                            <tr>
                                <td align="center"></td>
